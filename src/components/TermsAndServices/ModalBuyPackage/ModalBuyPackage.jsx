  ...
  return (
    <ModalBuyPackageWrapper>
      {isLoadingModalBuyBanner ? (
        <div className="loading_wrapper" style={{ width: '30rem', height: '30rem' }}>
          <Loading />
        </div>
      ) : (
        <form
        ...
        /> */}
          <Controller
            ...
            control={control}
            render={({ field }) => (
              <Select {...register} {...field} className="item_select" defaultValue={null}>
          ...
          />
          {selectedCardContent.type !== 'hot_game' && selectedCardContent.type !== 'top_game' && (
            <Upload
